...
<Helmet>
  <title>
    Web Development, Video Editing & Graphic Design Services | Genkit
  </title>

  <meta
    name="description"
    content="Explore Genkit's professional web development, video editing, and graphic design services built to help businesses grow."
  />

  <link
    rel="canonical"
    href="https://genkit.in/service"
  />

  <meta
    property="og:title"
    content="Web Development, Video Editing & Graphic Design Services | Genkit"
  />

  <meta
    property="og:description"
    content="Professional web development, video editing, and graphic design services from Genkit."
  />

  <meta
    property="og:url"
    content="https://genkit.in/service"
  />
            ...
            <div className="content-wrap-service">
              <div className="service-cards">
                <div className="img-content-service">
                  <img
  src={webDevelopment}
  alt="Professional web development service"
/>
                </div>
                <div className="content-service">
                  ...
                  <p>
                    ...
                    home. We specialize in crafting modern, responsive and high
                    performing websites that reflect your identity, drive
...
/>
                ...
                <div className="content-service">
                  <h4>Video Editing</h4>
                  <p>
                    "Turn Raw Footage into Powerful Stories."
                    {isMobile ? " " : <br />}Your moments, your message-
                    perfectly polished. Our video editing services transform
                    basic clips into compelling visual stories that grab
                    attention, spark emotion, and drive results.
                  </p>
              ...
              <div className="service-cards">
                <div className="img-content-service">
                  <img
  src={graphicDesign}
  alt="Professional graphic design service"
/>
                </div>
                <div className="content-service">
                  <h4>Graphic Designing</h4>
                  <p>
                    "Designs That Speak Louder Than Words." Your brand's visual
                    identity is your first impression-make it unforgettable. We
                    create bold,meaningful and visually stunning graphics that
                    communicate your message with style and clarity.
                  </p>
                        ...
                        <g mask="url(#mask-3)">
                          <g transform="translate(0.000000, -9.246050)">
                            ...
                            <path
                              ...
                              fillRule="evenodd"
                              d="M50.3909707,0.809029345 L49.6975169,1.15575621 L50.6221219,1.15575621 L50.3909707,0.809029345 Z"></path>
                            <path
                            ...
                            <path
                              ...
                              fillRule="evenodd"
                              d="M111.299323,104.711512 L110.952596,104.133634 L110.952596,104.942664 L111.299323,104.711512 Z"></path>
                            <path
                  ...
                  <svg
                    ...
                    <g>
                      <radialGradient
                        ...
                        />
                        <stop offset="1" style={{ stopColor: "#1A1107" }} />
                      </radialGradient>
          ...
          <section className="section-4-service">
            ...
            <div className="content-wrapper-service" id="Web-Development">
              <div className="text-grid-service text-1-service">
                ...
                <ul>
                  <li>
                    <span>Custom-designed websites</span> tailored to match your
                    brand and business goals.We build unique, user-focused
                    websites that reflect your identity and drive engagement.
                  </li>
                  {isMobile ? (
                    ""
                  ) : (
                    <li>
                      Secure and scalable solutions that grow with your
                      business.From <span>startups to enterprises</span>, we
                      create future-ready websites that adapt as you expand.
                    </li>
                  )}
                  <li>
                    Ongoing support and maintenance to keep your site running
                    smoothly.We offer continuous updates, security checks, and
              ...
              <div
                className="img-grid-service slide-up img-2-service"
                id="Video-Editing">
              ...
              <div className="text-grid-service text-2-service">
                ...
                <ul>
                  <li>
                    We craft videos that align with your brand’s tone,
                    delivering clear and engaging storytelling. Our edits
                    include high-quality visuals, crisp audio, and seamless
                    motion for maximum impact.
                  </li>
                  <li>
                    Optimized videos for all platforms{" "}
                    <span>YouTube, Instagram, Reels, and more</span>. We format
                    content to perform perfectly across social media, web, and
                    mobile platforms.
                  </li>
                  {isMobile ? (
                    ""
                    ...
                    <li>
                      Quick turnaround and revisions to ensure perfect final
                      output.Timely delivery with flexible edits means your
                      video is polished and ready when you need it.
                    </li>
                  )}
                </ul>
              </div>
              <div className="text-grid-service text-3-service">
                ...
                <ul>
                  <li>
                    Visually striking designs that communicate your brand's
                    identity. We design impactful visuals that reflect your
                    brand values, voice, and personality.
                  </li>
                  <li>
                    <span>Custom logos, banners, and </span>
                    <span>social media creatives</span> made to stand out.From
                    unique logos to engaging posts, our designs help your brand
                  ...
                  {isMobile ? (
                    ...
                    <li>
                      Print-ready and digital-friendly assets for any platform
                      or format. Whether it’s for online use or physical print,
                      we ensure flawless resolution and consistency.
                    </li>
                  )}
                </ul>
              </div>
              <div
                className="img-grid-service slide-up img-3-service"
                id="Graphic-Desiging">
